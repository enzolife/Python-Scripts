...
def calculate_order_gmv_by_shop():
    ...
    if frame is not False:
        ...
        grouped1 = frame1.groupby([frame1['Seller User ID'], frame1['ShopId(S)'], frame1['Username(S)'], frame1['Country']])
        ...
        grouped2 = frame2.groupby([frame2['Seller User ID'], frame2['ShopId(S)'], frame2['Username(S)'], frame2['Country']])
        ...
        grouped3 = frame3.groupby([frame3['Seller User ID'], frame3['ShopId(S)'], frame3['Username(S)'], frame3['Country']])
        ...
        grouped4 = frame4.groupby([frame4['Seller User ID'], frame4['ShopId(S)'], frame4['Username(S)'], frame4['Country']])
        ...
        grouped5 = frame5.groupby([frame5['Seller User ID'], frame5['ShopId(S)'], frame5['Username(S)'], frame5['Country']])
        ...
        print('\nOrder Reports not downloaded yet!')
